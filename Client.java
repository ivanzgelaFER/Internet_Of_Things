...
public class Client {
	private static String brokerAddress = "tcp://10.7.247.49:1883";
	...
	public static void main(String[] args) {
		try {
			_client = new MqttClient(brokerAddress, clientName, new MemoryPersistence());
			clientCONNECT();
	...
	private static void clientCONNECT() {
		...
		MqttCallback callback = new MqttCallback() {
			...
			public void messageArrived(String topic, MqttMessage message) {
				...
				sendMsgToTopic(value, actuationOutput);
			}
